                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="autogenerated_password"
                                               name="autogenerated_password" checked>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="officer_name" name="officer_name"
                                           value="{{ old('officer_name') }}" required>
                                </div>
                                <!-- Added status box -->
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="prosecutor_name" name="prosecutor_name"
                                           value="{{ old('prosecutor_name') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="prosecutor_number" class="form-label">Number</label>
                                    <input type="tel" class="form-control" id="prosecutor_number"
                                           name="prosecutor_number" value="{{ old('prosecutor_number') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="prosecutor_email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="prosecutor_email"
                                           name="prosecutor_email" value="{{ old('prosecutor_email') }}">
                                </div>
                                ...
                                <div id="witnesses" class="row">
                                    <div class="witness row mb-3">
                                        <div class="witness mb-3 col-md-7">
                                            ...
                                            <input type="text" class="form-control" id="witness_name_0"
                                                   name="witnesses[0][name]" value="{{ old('witnesses.0.name') }}">
                                        </div>
                                        <div class="witness mb-3 col-md-5">
                                            <label for="witness_contact_0" class="form-label">Docket Number</label>
                                            <input type="tel" class="form-control" id="witness_contact_0"
                                                   name="witnesses[0][contact]"
                                                   value="{{ old('witnesses.0.contact') }}">
                                        </div>
                                    </div>
                                </div>
                                <button type="button" class="btn btn-secondary" id="addWitness">Add Another Charge
                                </button>
                            </div>
                        </div>
